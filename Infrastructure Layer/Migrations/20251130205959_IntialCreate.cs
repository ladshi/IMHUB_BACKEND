        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportsColor = table.Column<bool>(type: "bit", nullable: false),
                    SupportsDuplex = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CsvUploadId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    GeneratedPdfUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contents_TemplateVersions_TemplateVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TemplatePages_TemplateVersions_TemplateVersionId",
                        column: x => x.TemplateVersionId,
                        principalTable: "TemplateVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentStatus = table.Column<int>(type: "int", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sendouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sendouts_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sendouts_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sendouts_Printers_PrinterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    X = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    Y = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    Width = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                    Height = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TemplateFields_TemplatePages_TemplatePageId",
            ...
            migrationBuilder.CreateTable(
                name: "SendoutStatusHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SendoutId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SendoutStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SendoutStatusHistories_Sendouts_SendoutId",
                        column: x => x.SendoutId,
                        principalTable: "Sendouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContentFieldValues_TemplateFields_TemplateFieldId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentFieldValues_TemplateFieldId",
                table: "ContentFieldValues",
                column: "TemplateFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_Contents_TemplateVersionId",
                table: "Contents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sendouts_ContentId",
                table: "Sendouts",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_Sendouts_JobReference",
                table: "Sendouts",
                column: "JobReference",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sendouts_OrganizationId",
                table: "Sendouts",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Sendouts_PrinterId",
                table: "Sendouts",
                column: "PrinterId");

            migrationBuilder.CreateIndex(
                name: "IX_SendoutStatusHistories_SendoutId",
                table: "SendoutStatusHistories",
                column: "SendoutId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateFields_TemplatePageId",
                table: "TemplateFields",
                column: "TemplatePageId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplatePages_TemplateVersionId",
                table: "TemplatePages",
                column: "TemplateVersionId");
